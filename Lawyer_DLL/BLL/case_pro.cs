...
namespace Lawyer_DLL.BLL
{
	...
	{
		private readonly Lawyer_DLL.DAL.case_pro dal=new Lawyer_DLL.DAL.case_pro();
		public case_pro()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Lawyer_DLL.Model.case_pro GetModelByCache(int ProID)
		{
			
			string CacheKey = "case_proModel-" + ProID;
			...
			return (Lawyer_DLL.Model.case_pro)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Lawyer_DLL.Model.case_pro> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Lawyer_DLL.Model.case_pro> DataTableToList(DataTable dt)
		{
			List<Lawyer_DLL.Model.case_pro> modelList = new List<Lawyer_DLL.Model.case_pro>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Lawyer_DLL.Model.case_pro model;
