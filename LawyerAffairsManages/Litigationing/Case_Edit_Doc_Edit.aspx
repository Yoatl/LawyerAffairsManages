<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Case_Edit_Doc_Edit.aspx.cs" Inherits="LawyerAffairsManages.Litigationing.Case_Edit_Doc_Edit" %>
    ...
    <table class="table-form">
        ...
        <tr id="jz2" runat="server">
            ...
            <td class="table-td-content">
                <telerik:RadDatePicker ID="RadDatePicker1" Runat="server" Skin="Silk" Culture="zh-CN" SelectedDate="2017-05-09">
                    ...
                    <DateInput DisplayDateFormat="yyyy/M/d" DateFormat="yyyy/M/d" LabelWidth="40%" DisplayText="2017/5/9" SelectedDate="2017-05-09" value="2017/5/9">
        ...
        <tr>
            ...
            <td class="table-td-content">
                <telerik:RadTextBox ID="RadTextBox1" Runat="server" Skin="Silk" Text="XX-15560050">
                </telerik:RadTextBox>
            </td>
        </tr>
        <tr>
            ...
            <td class="table-td-content">
                <telerik:RadTextBox ID="RadTextBox2" runat="server" Skin="Silk" Width="284px" Text="律师函">
                </telerik:RadTextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="table-td-content">
                <textarea id="TextArea1" cols="20" rows="1" class="auto-style9" name="S1">案子很重要！</textarea> </td>
        </tr>
        <tr class="caption">
            <td colspan="2">
