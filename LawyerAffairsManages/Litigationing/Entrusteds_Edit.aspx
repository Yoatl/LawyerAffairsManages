<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Entrusteds_Edit.aspx.cs" Inherits="LawyerAffairsManages.Litigationing.Entrusteds_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table-form">
        ...
        <tr class="caption">
            <td colspan="4">律师函发送日期</td>
        </tr>
        <tr>
            <td class="table-td-name">实际发送律师函日期：</td>
            <td class="table-td-content">
            ...
            <td class="table-td-name">奔驰委托发送律师函日期:</td>
            <td class="table-td-content">
