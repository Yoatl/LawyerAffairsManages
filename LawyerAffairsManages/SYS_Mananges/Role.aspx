                ...
                <telerik:RadGrid ID="RadGrid" runat="server" Culture="zh-CN" DataSourceID="XmlDataSource1" GroupPanelPosition="Top" Skin="Silk">
                    ...
                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="管理号" DataSourceID="XmlDataSource1">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="角色名称" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 角色名称 column" HeaderText="角色名称" SortExpression="角色名称" UniqueName="角色名称">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="角色说明" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 角色说明 column" HeaderText="角色说明" SortExpression="角色说明" UniqueName="角色说明">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="角色功能数" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 角色功能数 column" HeaderText="角色功能数" SortExpression="角色功能数" UniqueName="角色功能数">
                            </telerik:GridBoundColumn>
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
