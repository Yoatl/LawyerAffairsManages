    ...
    <table class="table-form">
        ...
        <tr>
            <td class="table-td-content">
                <telerik:RadGrid ID="RadGrid1" runat="server" Culture="zh-CN" DataSourceID="XmlDataSource1" GroupPanelPosition="Top" Skin="Silk">
                    ...
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="管理号" ClientDataKeyNames="管理号" DataSourceID="XmlDataSource1">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="名称" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 名称 column" HeaderText="名称" SortExpression="名称" UniqueName="名称">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="说明" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 说明 column" HeaderText="说明" SortExpression="说明" UniqueName="说明">
                            </telerik:GridBoundColumn>
