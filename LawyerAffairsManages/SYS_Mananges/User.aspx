            ...
            <td colspan="5">
                <telerik:RadGrid ID="RadGrid" runat="server" Culture="zh-CN" DataSourceID="XmlDataSource1" GroupPanelPosition="Top" Skin="Silk">
                    ...
                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="管理号" DataSourceID="XmlDataSource1">
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="管理号" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 管理号 column" HeaderText="管理号" SortExpression="管理号" UniqueName="管理号">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="用户名" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 用户名 column" HeaderText="用户名" SortExpression="用户名" UniqueName="用户名">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="姓名" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 姓名 column" HeaderText="姓名" SortExpression="姓名" UniqueName="姓名">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="电话" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 电话 column" HeaderText="电话" SortExpression="电话" UniqueName="电话">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="角色" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 角色 column" HeaderText="角色" SortExpression="角色" UniqueName="角色">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="用户类型" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 用户类型 column" HeaderText="用户类型" SortExpression="用户类型" UniqueName="用户类型">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="启用状态" HeaderStyle-Height="35px" ItemStyle-Height="35px" FilterControlAltText="Filter 启用状态 column" HeaderText="启用状态" SortExpression="启用状态" UniqueName="启用状态">
                            </telerik:GridBoundColumn>
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
